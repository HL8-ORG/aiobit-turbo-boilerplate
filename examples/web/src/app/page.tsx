import { Badge } from "@pkg/design-system/components/shadcn/badge";
...
const techStack = [
  ...
  {
    name: "Turborepo",
    color: "bg-linear-to-r from-[#FF1E56] to-[#0196FF] text-white",
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button
                ...
                asChild
              >
                <Link href="https://github.com/ProductOfAmerica/turbo-starter">
                  turbo-starter
                </Link>
              </Button>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto">
                A modern monorepo starter template that scales with your
                ambitions. Production-ready from day one.
              </p>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Carefully selected tools and configurations to accelerate your
              ...
              <Card className="border-border bg-card">
                ...
                <CardContent className="space-y-4">
                  <div className="bg-muted rounded-lg p-4 font-mono text-sm overflow-x-auto">
                    <div className="text-foreground">
                      ...
                      <span className="text-blue-600 dark:text-blue-400">
                        git clone
                        https://github.com/ProductOfAmerica/turbo-starter.git
                      </span>
                    </div>
                    <div className="text-foreground">
                      ${" "}
                  ...
                  <p className="text-sm text-muted-foreground">
                    Clone the repository and start developing immediately with
                    hot reload
                  </p>
                </CardContent>
              </Card>
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    {
                      cmd: "pnpm lint",
                      desc: "Check code quality across the monorepo",
                    },
                    {
                      cmd: "pnpm format-write",
                      desc: "Auto-format all code with Biome",
                    },
                    {
                      cmd: "pnpm docker",
                      desc: "Run the entire stack with Docker",
                    },
                  ].map((item) => (
                    <div
                      key={item.cmd}
      ...
      <section className="py-24 bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-lg text-muted-foreground">
              Join developers who are shipping faster with our modern monorepo
              setup
            </p>
